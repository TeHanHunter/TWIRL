...
/sw/qlp-environment/.venv/bin/python \
  ...
  --out-dir reports/stage5_validation/s56_1k_predetrend_detrending_method_sweep_envelope_pdo \
  --raw-aperture Small \
  ...
  --method pctl75_03_gap05 \
  --method pctl60_06_gap05 \
  --method pctl75_06_gap05 \
  --method pctl90_06_gap05 \
  --method pctl75_10_gap05 \
  --method pctl75_20_gap05 \
