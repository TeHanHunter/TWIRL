...
For a short list of known transit hosts (benchmark/s96_qa/targets.json), this
driver:
...
Typical invocation (inside tmux on pdogpu1):
    ...
    python scripts/stage1_lcs/run_s96_qa_benchmark.py \
        --targets-json benchmark/s96_qa/targets.json \
...
is done locally by benchmark/plot_tglc_tica_vs_qlp_s96.py after scping the
