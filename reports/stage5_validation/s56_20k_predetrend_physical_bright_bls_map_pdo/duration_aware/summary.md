...
BLS input: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/small_pair_200k/injection_bls_recoveries.csv`
...
- Rows: `20000`
- Recovered exact/top-N/harmonic: `7910`
- AUC: `0.931`
- Log loss: `0.329`
...
| --- | ---: |
| `log10_radius2_sqrt_duration_over_period` | `1.918` |
| `tmag` | `-1.175` |
...
| --- | ---: | ---: | ---: |
| Tmag < 17 | 5020 | 3154 | 62.8% |
| 17 <= Tmag < 18 | 4994 | 2273 | 45.5% |
| 18 <= Tmag < 19 | 5026 | 1625 | 32.3% |
| Tmag > 19 | 4960 | 858 | 17.3% |
...
- `period_radius_boundary_png`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/period_radius_50pct_boundary_by_duration.png`
- `period_radius_boundary_pdf`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/period_radius_50pct_boundary_by_duration.pdf`
- `period_radius_recovery_map_png`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/period_radius_recovery_fraction_by_duration_tmag.png`
- `period_radius_recovery_map_pdf`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/period_radius_recovery_fraction_by_duration_tmag.pdf`
- `period_radius_recovery_map_csv`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/period_radius_recovery_fraction_by_duration_tmag.csv`
- `period_radius_empirical_publication_png`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/period_radius_empirical_recovery_publication.png`
- `period_radius_empirical_publication_pdf`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/period_radius_empirical_recovery_publication.pdf`
- `period_radius_empirical_publication_csv`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/period_radius_empirical_recovery_publication_grid.csv`
- `radius_snr_proxy_png`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/radius_snr_proxy_recovery_by_tmag.png`
- `radius_snr_proxy_pdf`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/radius_snr_proxy_recovery_by_tmag.pdf`
- `duration_radius_floor_png`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/duration_radius_50pct_boundary_floor_maps.png`
- `duration_radius_floor_pdf`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/duration_radius_50pct_boundary_floor_maps.pdf`
- `bls_vs_leo_png`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/bls_vs_leo_recovery_contingency.png`
- `bls_vs_leo_pdf`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/bls_vs_leo_recovery_contingency.pdf`
- `leo_metric_diagnostics_png`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/leo_bls_metric_diagnostics.png`
- `leo_metric_diagnostics_pdf`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/leo_bls_metric_diagnostics.pdf`
- `leo_metric_summary_csv`: `reports/stage5_validation/s56_20k_predetrend_physical_bright_bls_map_pdo/duration_aware/leo_bls_metric_summary.csv`
